...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "বায়তুর রহমান জামে মসজিদ — Baitur Rahman Jame Moshjid" },
      {
        name: "description",
        content:
          "Prayer times, donations, events and community programs at Baitur Rahman Jame Moshjid. A sanctuary of peace and faith.",
      },
      { property: "og:title", content: "Baitur Rahman Jame Moshjid" },
      {
